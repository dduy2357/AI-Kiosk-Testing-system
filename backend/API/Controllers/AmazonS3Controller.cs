...
namespace API.Controllers
{
    ...
    [ApiController]
    [AuthenPermission]
    public class AmazonS3Controller : Authentication.Authentication
    {
        private readonly IAmazonS3Service _s3Service;
        private readonly IAmazonS3 _s3Client;
        private const string BucketName = "akts";      // change this to your bucket name

        public AmazonS3Controller(IAmazonS3Service s3Service, IAmazonS3 s3Client, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
